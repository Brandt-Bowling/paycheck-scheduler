          ...
          <div className="bg-slate-800 rounded-3xl shadow-xl p-5 sm:p-8">
            <header className="text-center mb-8 relative">
              <button
                  ...
                  className="absolute left-0 top-1 text-slate-400 hover:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md transition-colors px-2 py-1 -ml-2" aria-label="Back to calendar"
              >
                  &larr; Back
              </button>
        ...
        <div className="mx-auto max-w-md mt-6 sm:mt-10">
          <div className="bg-slate-800 rounded-3xl shadow-xl p-5 sm:p-8">
            <header className="text-center mb-8 relative flex items-center justify-center">
              ...
              <button
                onClick={() => setSelectedTab('calendar')}
                className="absolute right-0 top-1 text-slate-400 hover:text-slate-200 p-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md transition-colors"
          ...
          <div className="bg-slate-800 rounded-3xl shadow-xl p-5 sm:p-8">
            <header className="text-center mb-8 relative flex items-center justify-center">
              <button
                ...
                className="absolute left-0 top-1 text-slate-400 hover:text-slate-200 p-2 flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md transition-colors"
